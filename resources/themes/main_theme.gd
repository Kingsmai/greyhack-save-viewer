...
const CLOSE_BUTTON_ICON = "res://assets/ui-pack/window_control/grey_icon_cross.png"
const CLOSE_BUTTON_BG = "res://assets/ui-pack/window_control/red_button_square_flat.png"
const CLOSE_BUTTON_HOVER_BG = "res://assets/ui-pack/window_control/red_button_square_gloss.png"
const CLOSE_BUTTON_PRESSED_BG = "res://assets/ui-pack/window_control/red_button_square_gradient.png"

const PANEL_BG = "res://assets/ui-pack/panel/panel_square_depth_line.png"
const PANEL_GREEN_BG = "res://assets/ui-pack/panel/button_square_depth_flat.png"

const BUTTON_BG = "res://assets/ui-pack/primary/button_square_depth_gradient.png"
const BUTTON_HOVER_BG = "res://assets/ui-pack/primary/button_square_depth_gloss.png"
const BUTTON_PRESSED_BG = "res://assets/ui-pack/primary/button_square_gradient.png"
const BUTTON_HOVER_PRESSED_BG = "res://assets/ui-pack/primary/button_square_gloss.png"
const BUTTON_DISABLED_BG = "res://assets/ui-pack/primary/button_square_line.png"

const CHECKBOX_UNCHECKED_DISABLED = "res://assets/ui-pack/checkboxes/check_square_grey.png"
const CHECKBOX_UNCHECKED = "res://assets/ui-pack/checkboxes/check_square_color.png"
const CHECKBOX_CHECKED_DISABLED = "res://assets/ui-pack/checkboxes/check_square_grey_checkmark.png"
const CHECKBOX_CHECKED = "res://assets/ui-pack/checkboxes/check_square_color_checkmark.png"
const RADIO_UNCHECKED_DISABLED = "res://assets/ui-pack/checkboxes/check_round_grey.png"
const RADIO_UNCHECKED = "res://assets/ui-pack/checkboxes/check_round_color.png"
const RADIO_CHECKED_DISABLED = "res://assets/ui-pack/checkboxes/check_round_round_circle.png"
const RADIO_CHECKED = "res://assets/ui-pack/checkboxes/check_round_round_circle.png"

const INPUT_BG = "res://assets/ui-pack/input/input_square.png"
const INPUT_FOCUS_BG = "res://assets/ui-pack/input/input_square.png"

const TAB_PANEL_BG = "res://assets/ui-pack/tab_container/button_square_flat_grey.png"
const TAB_SELECTED_BG = "res://assets/ui-pack/tab_container/button_square_flat.png"
const TAB_UNSELECTED_BG = "res://assets/ui-pack/tab_container/button_square_gradient.png"
const TAB_HOVER_BG = "res://assets/ui-pack/tab_container/button_square_gloss.png"
const TAB_DISABLED_BG = "res://assets/ui-pack/tab_container/button_square_flat_grey.png"

const TREE_PANEL_BG = "res://assets/ui-pack/tree/button_square_line.png"
const TREE_ICON_EXPAND = "res://assets/ui-pack/tree/icon_arrow_down_dark.png"
const TREE_ICON_COLLAPSE = "res://assets/ui-pack/tree/icon_arrow_up_dark.png"
const TREE_SELECTED_BG = "res://assets/ui-pack/tree/button_square_flat.png"
const TREE_HOVER_BG = "res://assets/ui-pack/tree/button_square_gloss.png"
const TREE_CHECKBOX_UNCHECKED_DISABLED = "res://assets/ui-pack/tree/check_square_grey.png"
const TREE_CHECKBOX_UNCHECKED = "res://assets/ui-pack/tree/check_square_color.png"
const TREE_CHECKBOX_CHECKED_DISABLED = "res://assets/ui-pack/tree/check_square_grey_checkmark.png"
const TREE_CHECKBOX_CHECKED = "res://assets/ui-pack/tree/check_square_color_checkmark.png"

const PROGRESS_BAR_BG = "res://assets/ui-pack/progress_bar/bar_shadow_round_outline_small.svg"
const PROGRESS_BAR_FILL = "res://assets/ui-pack/progress_bar/bar_round_gloss_small.svg"

const SCROLL_BAR_BG = "res://assets/ui-pack/scroll_bar/bar_shadow_square_small_square.svg"
const SCROLL_BAR_GRABBER = "res://assets/ui-pack/scroll_bar/bar_square_small_square.svg"
const SCROLL_BAR_GRABBER_HIGHLIGHT = "res://assets/ui-pack/scroll_bar/bar_square_gloss_small_square.svg"
